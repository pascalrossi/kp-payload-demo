...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_text_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_text_block_order_idx\` ON \`pages_blocks_text_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_text_block_parent_id_idx\` ON \`pages_blocks_text_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_text_block_path_idx\` ON \`pages_blocks_text_block\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_text_block_locale_idx\` ON \`pages_blocks_text_block\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_team_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_team_section_order_idx\` ON \`pages_blocks_team_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_team_section_parent_id_idx\` ON \`pages_blocks_team_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_team_section_path_idx\` ON \`pages_blocks_team_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_team_section_locale_idx\` ON \`pages_blocks_team_section\` (\`_locale\`);`)
  ...
  await db.run(sql`CREATE INDEX \`pages_rels_team_id_idx\` ON \`pages_rels\` (\`team_id\`,\`locale\`);`)
  await db.run(sql`CREATE TABLE \`team_expertise\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`team_expertise_order_idx\` ON \`team_expertise\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`team_expertise_parent_id_idx\` ON \`team_expertise\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`team_expertise_locale_idx\` ON \`team_expertise\` (\`_locale\`);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_text_block\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_team_section\`;`)
  await db.run(sql`DROP TABLE \`pages\`;`)
  await db.run(sql`DROP TABLE \`pages_locales\`;`)
  await db.run(sql`DROP TABLE \`pages_rels\`;`)
  await db.run(sql`DROP TABLE \`team_expertise\`;`)
